        ...
        <div className='w-full h-[80%] rounded-2xl bg-white shadow-2xl m-8 flex flex-col items-center text-black'>
            ...
            <div className='w-full'>
                <div className='flex flex-col items-center mb-4'>
                    ...
                    <input type="text" id='identifiant' className='w-[80%] h-[38px] bg-gray-200 rounded-xl pl-2 inset-shadow-xl' />
                </div>
                <div className='flex flex-col items-center'>
                    <label htmlFor="password" className='mb-2'>Mot de passe</label>
                    <input type="text" id='password' className='w-[80%] h-[38px] bg-gray-200 rounded-xl pl-2 inset-shadow-xl' />
                </div>
            </div>
            ...
            <nav className='mt-8 flex flex-row-reverse justify-between w-[80%]'>
                <button className='w-[35%] h-[50px] rounded-2xl bg-cyan-400 text-white flex justify-center items-center'>
